...
ENTRYPOINT ["java", "-Xgcpolicy=metronome", "-Xgc:targetUtilization=80", "-Xgc:targetPauseTime=10", "-Xtune:virtualized", "-XX:+IdleTuningGcOnIdle", "-jar", "/app/persistence-0.0.1-SNAPSHOT.jar", "--spring.profiles.active=prod"]
EXPOSE 8081