...
import org.papertrail.persistence.exceptions.handler.ErrorResponse;
...
public class MessageLogContentController {
    ...
    @ApiResponse(responseCode = "201", description = "Message successfully logged", content = @Content(schema = @Schema(implementation = MessageLogContentDTO.class)))
    ...
    @ApiResponse(responseCode = "409", description = "Message has already been logged", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    @PostMapping
    ...
    @ApiResponse(responseCode = "200", description = "Message found", content = @Content(schema = @Schema(implementation = MessageLogContentDTO.class)))
    @ApiResponse(responseCode = "404", description = "Message not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    ...
    @ApiResponse(responseCode = "200", description = "Message updated successfully", content = @Content(schema = @Schema(implementation = MessageLogContentDTO.class)))
    @ApiResponse(responseCode = "400", description = "Invalid request payload", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    @ApiResponse(responseCode = "404", description = "Message not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    @PutMapping
